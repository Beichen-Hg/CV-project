...
# 加载训练好的ResNet模型
resnet_model = models.resnet50(pretrained=False)   # pretrained=False表示不加载预训练的权重
...
model_weights = torch.load(r"D:\pycharm\pycharm file\CV_group_assignment\test_best_model_weights.pth")
